...
(function() {
  ...
  j.setDocument = function(w) {
      ...
      if (z.querySelectorAll) {
        try {
          ...
          o.starSelectsClosedQSA =
            s && !!s.length && s[0].nodeName.charAt(0) == "/";
        } catch (v) {}
        try {
        ...
        try {
          ...
          o.brokenEmptyAttributeQSA =
            z.querySelectorAll('[class*=""]').length != 0;
        } catch (v) {}
      }
      try {
    ...
    o.hasAttribute =
      y && this.isNativeCode(y.hasAttribute)
        ? function(C, B) {
    ...
    o.contains =
      y && this.isNativeCode(y.contains)
        ? function(B, C) {
            return B.contains(C);
          }
        : y && y.compareDocumentPosition
        ? function(B, C) {
    ...
    o.documentSorter = y.compareDocumentPosition
      ? function(C, B) {
  ...
  j.search = function(q, D, O, v) {
        ...
        if (!K) {
          ...
          if (K == "#") {
            ...
            if (K == ".") {
              if (
                !this.isHTMLDocument ||
                ((!q.getElementsByClassName || this.brokenGEBCN) &&
                  q.querySelectorAll)
              ) {
                break simpleSelectors;
              }
    ...
    this.posNTHTypeLast = {};
    this.push =
      !y && (v || (z.length == 1 && z.expressions[0].length == 1))
        ? this.pushArray
        : this.pushUID;
    if (B == null) {
      B = [];
    ...
    for (q = 0; (currentExpression = r[q]); q++) {
      if (currentExpression.length == 1) {
        ...
        if (
          this.matchSelector(
            m,
            this.isXMLDocument ? o.tag : o.tag.toUpperCase(),
            o.id,
            o.classes,
            o.attributes,
            o.pseudos
  ...
  j.matchSelector = function(n, u, c, o, p, r) {
    ...
    if (p) {
      for (q = p.length; q--; ) {
        ...
        if (
          m.operator
            ? !m.test(this.getAttribute(n, m.key))
            : !this.hasAttribute(n, m.key)
        ) {
          return false;
        }
      }
    ...
    " ": function(p, v, m, q, r, t, o) {
      ...
      if (this.isHTMLDocument) {
        getById: if (m) {
          ...
          if (
            (!u && p.all) ||
            (this.idGetsName && u && u.getAttributeNode("id").nodeValue != m)
          ) {
            n = p.all[m];
            if (!n) {
              return;
  ...
  var k = {
    empty: function(c) {
      var m = c.firstChild;
      return (
        !(m && m.nodeType == 1) && !(c.innerText || c.textContent || "").length
      );
    },
    not: function(c, m) {
    ...
    "nth-last-child": j.createNTHPseudo(
      "lastChild",
      "previousSibling",
      "posNTHLast"
    ),
    "nth-of-type": j.createNTHPseudo(
      "firstChild",
      "nextSibling",
      "posNTHType",
      true
    ),
    "nth-last-of-type": j.createNTHPseudo(
      "lastChild",
      "previousSibling",
      "posNTHTypeLast",
      true
...
(function() {
  ...
  Element.implement({
    ...
    getElementById: function(p) {
      return document.id(
        Slick.find(this, "#" + ("" + p).replace(/(\W)/g, "\\$1"))
      );
    },
    getSelected: function() {
      this.selectedIndex;
      return new Elements(
        Array.from(this.options).filter(function(p) {
          return p.selected;
        })
      );
    },
    ...
    getStyle: function(l) {
      ...
      if (Browser.opera || (Browser.ie && isNaN(parseFloat(f)))) {
        if (/^(height|width)$/.test(l)) {
          ...
          g.each(function(m) {
            i +=
              this.getStyle("border-" + m + "-width").toInt() +
              this.getStyle("padding-" + m).toInt();
          }, this);
...
var Event = new Type("Event", function(a, i) {
  ...
  if (n.indexOf("key") != -1) {
    ...
    if (/click|mouse|menu/i.test(n)) {
      ...
      if (/over|out/.test(n)) {
        q =
          a.relatedTarget || a[(n == "mouseover" ? "from" : "to") + "Element"];
        var j = function() {
    ...
    onAdd: function(g) {
      ...
      if (Browser.ie6 || Browser.ie7) {
        e = function(m, q) {
          ...
          var t,
            p,
            w = unescape(new String(window.location));
          if (s) {
            p = t = "#";
          } else {
            if (l) {
        ...
        if (window.retrieve("hashchange:implemented")) {
          e = window.onhashchange = function(l) {
            l =
              l && typeof l == "string" ? l : new String(window.location.hash);
            k.delay(1, window, [l]);
          };
        } else {
          if (Browser.opera) {
          ...
          e = function(o) {
            ...
            if (
              o.length == 0 &&
              new String(window.location).indexOf("#") >= 0
            ) {
              m = "#";
            }
...
(function() {
  ...
  var a = (this.BVLayer = new Class({
    ...
    setHoverable: function(d) {
      ...
      this.element.style.pointerEvents =
        this.touchable || this.hoverable ? "auto" : "none";
      if (d) {
  ...
  a._initializeQuirks = function() {
    ...
    c.stylePrefix = Browser.ie
      ...
      ? "O"
      : "";
    c.stylePrefixCSS = c.stylePrefix
      ? "-" + c.stylePrefix.toLowerCase() + "-"
      : "";
  ...
  a._initializeDefaultProperties = function() {
    ...
    if (c.areTransitionsAvailable) {
      e[d + "TransitionProperty"] = c.isAccelerationAvailable
        ? c.stylePrefixCSS + "transform, opacity"
        : "left, top, opacity";
      e[d + "TransitionDuration"] = "0s";
      e[d + "TransitionTimingFunction"] = "ease-in-out";
    }
    a._defaultProperties = { styles: e };
  };
...
(function() {
  var a = (this.BVTouches = new Class({
    initialize: function(c, d) {
      this.layer = c;
      this.globalPoint = { x: d.page.x, y: -d.page.y };
    ...
    _goUpWithEvent: function(c) {
      ...
      this.count = 0;
      var d =
        Math.abs(this.translation.x) > 10 || Math.abs(this.translation.y) > 10;
      var e =
        Math.abs(this.velocity.x) > 400 || Math.abs(this.velocity.y) > 400;
      this.wasTap = !d && !e && this.getTimeSinceGoingDown() < 300;
      this.wasDoubleTap =
        this.wasTap &&
        this.timestamp - (this.layer.timestampOfLastTap || 0) < 400;
      if (this.wasTap) {
...
(function() {
  ...
  var j = new Class({
    ...
    initialize: function(p, o) {
      ...
      this.spinner.setPosition(
        0.5 * (m.width - this.spinner.width),
        -0.5 * (m.height - this.spinner.height)
      );
  ...
  var c = new Class({
    initialize: function(m, p) {
      ...
      this.iframe = new IFrame({
        ...
        events: { load: this.iframeDidLoad.bind(this) },
        width: "" + m.width,
        height: "" + m.height,
        frameBorder: "0",
        scrolling: "no"
      ...
      this.iframeUpdateInterval = this.updateIframeVisibilityAndHeight.periodical(
        500,
        this
      );
  ...
  c.preloadWithURL = function(m) {
    ...
    r.send();
    function o() {
      return new Request({ url: m, method: "get" });
    }
    function q(t) {
      ...
      return new Request({ url: p + s[1], method: "get" });
    }
    function n(t) {
  ...
  var h = new Class({
    initialize: function(m, n) {
      ...
      this.iframe = new IFrame({
        src:
          "http://player.vimeo.com/video/" + p + "?title=0&byline=0&portrait=0",
        styles: {
          position: "absolute",
          left: "" + o.x + "px",
          top: "" + -o.y + "px",
  ...
  var l = new Class({
    initialize: function(m, n) {
      ...
      this.iframe = new IFrame({
        src:
          "https://www.youtube.com/embed/" + p + "?autohide=1&rel=0&showinfo=0",
        styles: {
          position: "absolute",
          left: "" + o.x + "px",
          top: "" + -o.y + "px",
  ...
  var g = new Class({
    ...
    initialize: function(n, m) {
      ...
      this.element.setStyle(
        BVLayer.addPrefixToStyleName("TransformOrigin"),
        "50% 50%"
      );
...
(function() {
  var a = (this.Site = new Class({
    ...
    addEdgeShadows: function() {
      ...
      this.edgeShadows.topShadow.setContentsURLAndSize(
      ...
      this.edgeShadows.bottomShadow.setContentsURLAndSize(
        "Images/EdgeShadowBottom.png",
        this.width,
        200
      );
      this.edgeShadows.bottomShadow.setY(
        -this.height + this.edgeShadows.bottomShadow.height
      );
      this.edgeShadows.leftShadow = new BVLayer(this.edgeShadows);
      this.edgeShadows.leftShadow.setAccelerated(true);
      this.edgeShadows.leftShadow.setContentsURLAndSize(
      ...
      this.edgeShadows.rightShadow.setContentsURLAndSize(
        "Images/EdgeShadowRight.png",
        142,
        this.height
      );
      this.edgeShadows.rightShadow.setX(
        this.width - this.edgeShadows.rightShadow.width
      );
      this.edgeShadows.headerTitleShadow = new BVLayer(this.edgeShadows);
      this.edgeShadows.headerTitleShadow.setContentsURLAndSize(
    ...
    windowDidScroll: function(g) {
      ...
      if (this.zoomedSegment) {
        ...
        var e = this.zoomedSegment.properties.hideSiteHeight
          ? Math.max(
              360,
              this.zoomedSegment.properties.hideSiteHeight -
                this.zoomedSegment.page.y -
                this.height
            )
          : this.height * 2;
        f = h >= e;
    ...
    getSegmentPageInfos: function() {
      ...
      this.eachSegment(function(g) {
        var f = this.root.contentContainer.getContentSizeForProperties(
          g.properties,
          2000,
          2000
        );
    ...
    mouseWheelWithEvent: function(f) {
      ...
      var h = e.detail
        ? -e.detail
        : e.wheelDelta
        ? e.wheelDelta / (e.wheelDelta % 120 === 0 ? 120 : 3)
        : 0;
    ...
    setScrollOffset: function(g, f, e) {
      if (!e) {
        g = this.isZoomed
          ? g.limit(this.getMinScrollX(), this.getMaxScrollX())
          : 0;
        f = this.isZoomed
          ? f
          : f.limit(this.getMinScrollY(), this.getMaxScrollY());
      }
      this.scrollX = g;
      this.scrollY = f;
    ...
    updateBackgroundPosition: function() {
      this.background.setPosition(
        this.scrollX + this.backgroundOffsetX,
        this.scrollY + this.backgroundOffsetY
      );
    },
    ...
    updateDoodlePosition: function() {
      this.doodle.updateWithStrip(
        this.sections.sublayers[0].strips.sublayers[0]
      );
    },
    updateEdgeShadows: function() {
      this.edgeShadows.topShadow.setY(
        this.isZoomed ? this.edgeShadows.topShadow.height + 2 : this.scrollY
      );
      this.edgeShadows.bottomShadow.setHidden(this.isZoomed);
      this.edgeShadows.bottomShadow.setY(
        Math.min(-this.sections.height + this.scrollY, -this.height) +
          this.edgeShadows.bottomShadow.height
      );
    },
    setScrollY: function(e) {
      ...
      BVLayer.animate(
        ...
        function() {
          var f =
            (this.scrollY - this.getMinScrollY()) /
            (this.getMaxScrollY() - this.getMinScrollY());
    ...
    setScrollX: function(g) {
      ...
      var e =
        (this.scrollX - this.getMaxScrollX()) /
        (this.getMinScrollX() - this.getMaxScrollX());
    ...
    recenterBackgroundOffset: function() {
      ...
      f -=
        Math.floor(f / this.background.tileWidth) * this.background.tileWidth;
      this.backgroundOffsetX = f - this.scrollX;
      var e = this.backgroundOffsetY + this.scrollY;
      e -=
        Math.floor(e / this.background.tileHeight) * this.background.tileHeight;
    ...
    momentumScrollWithTouches: function(g) {
      ...
      this.momentumScrollInterval = this.updateMomentumScroll.periodical(
        20,
        this
      );
    },
    ...
    setZoomedSegment: function(j, f, i) {
      ...
      if (!l && k) {
        ...
        BVLayer.animate(
          this.zoomDuration,
          function() {
            var m = this.sections.getLocalPointForGlobalPoint(
              j.getGlobalPosition()
            ).y;
      ...
      (function() {
        ...
        var i = function(l) {
          if (l.accelerated) {
            ...
            l.setPosition(
              l.x + e * Math.cos(l.explodePhase),
              l.y + e * Math.sin(l.explodePhase)
            );
            l.explodePhase += k;
          }
          l.sublayers.each(i);
  ...
  var d = new Class({
    ...
    updateWithStrip: function(h) {
      ...
      this.rightDoodle.setPosition(
        f.x - this.rightDoodle.width + 18,
        f.y + this.rightDoodle.height - 7
      );
    },
...
(function() {
      ...
      this.strips.each(function(i, g) {
        ...
        if (i.isFirstInRow) {
          if (this.properties.centered) {
            i.setPositionOfLocalPoint(
              0.5 * this.site.width,
              d,
              0.5 * (i.width + i.segments.sublayers[0].width),
              0
            );
          } else {
          ...
          i.setX(
            Math.round(
              e.x + (i.paddingLeft + e.width) * Math.cos(kSiteStripRotation)
            )
          );
          i.setY(
            Math.round(
              j +
                e.y -
                h +
                (i.paddingLeft + e.width) * Math.sin(kSiteStripRotation)
            )
          );
        }
        c = f - 4;
  ...
  var a = new Class({
    ...
    initialize: function(g, j, f) {
      ...
      this.title.setPositionOfLocalPoint(
        0.5 * this.site.width,
        0,
        0.5 * this.titleWidth,
        0
      ...
      this.title.segmentOffsetUnzoomed = { x: c.x - i.x, y: c.y - i.y };
      ...
      this.subtitle.setPositionOfLocalPoint(
        0.5 * this.site.width,
        0,
        0.5 * this.subtitleWidth,
        -this.subtitleY
      );
      var e = this.subtitle.getGlobalPosition();
      this.subtitle.segmentOffsetUnzoomed = { x: e.x - i.x, y: e.y - i.y };
      this.subtitle.segmentOffsetZoomed = {
        x:
          this.subtitle.segmentOffsetUnzoomed.x +
          this.title.segmentOffsetZoomed.x -
          this.title.segmentOffsetUnzoomed.x,
        y:
          this.subtitle.segmentOffsetUnzoomed.y +
          this.title.segmentOffsetZoomed.y -
          this.title.segmentOffsetUnzoomed.y
      };
      if (j.properties.magicSubtitle) {
        this.magicSubtitleSpan = this.subtitle.textElement.getElementsByTagName(
          "span"
        )[0];
    ...
    showTitlesThatHaveScrolledOffscreen: function() {
      if (
        ...
        this.section.properties.hideSectionTitle
      ) {
        return;
      }
      var d = this.firstSegment.getGlobalPosition();
    ...
    addMagicToSubtitle: function() {
      ...
      this.magicSubtitleSpan.addEvent(
        "click",
        this.magicSubtitleWasClicked.bind(this)
      );
    },
    ...
    getMagicSubtitles: function() {
      if (!this.magicSubtitles) {
        this.magicSubtitles = this.getMagicCode()
          .split("OO")
          .map(function(c) {
            return c
              .match(/\w\w/g)
...
(function() {
  var a = (this.SiteStrip = new Class({
    ...
    initialize: function(g, h) {
      ...
      this.stripScaleForPageOffset =
        this.properties.scaleForPageOffset || this.stripScale;
      this.segmentSize = {
      ...
      if (h.title === null) {
        ...
        this.offLeft.setSize(
          Math.round((57 * this.segmentSize.height) / 235),
          this.segmentSize.height
        );
      ...
      if (this.isLastInSubsection) {
        this.offRight.setContentsURLAndSize(
          "Images/FilmLeft.png",
          this.segmentSize
        );
      } else {
        this.offRight.setContentsURL("Images/FilmOffright.png");
        this.offRight.setSize(
          Math.round((57 * this.segmentSize.height) / 235),
          this.segmentSize.height
        );
      }
  ...
  var b = (this.SiteStripHeaderTitle = new Class({
    ...
    updatePosition: function() {
      ...
      var f =
        this.strip.subsectionWidth -
        Math.round(
          0.5 * (this.site.width + this.segmentWidth) - this.segmentWidth
        );
      if (f <= i) {
        this.setGlobalPosition(h);
        return;
...
(function() {
  var b = (this.SiteStripSegment = new Class({
    ...
    initialize: function(i, e) {
      ...
      this.setTouchable(true);
      this.element.setStyle("cursor", "pointer");
      this.properties = this.site.mergePropertiesFromElement(
        this.strip.properties,
        e
      );
      ...
      this.setSize(
        this.strip.segmentSize.width * j,
        this.strip.segmentSize.height
      );
      var h = this.properties.filmEdges ? -29 : -14;
      var g = { x: Math.round(5 * k), y: Math.round(h * k) };
      var f = {
      ...
      var d =
        "Images/FilmMiddle" +
        (this.properties.filmEdges ? "" : "Solid") +
        ".png";
    ...
    parseSegmentElement: function(j) {
      ...
      if (k) {
        this.contentClickURL = ContentContainer.getBrowserSpecificURL(
          k.get("href")
        );
      } else {
    ...
    addContent: function() {
      ...
      if (gSiteShowThumbnailImages) {
        this.content.setContentsURLAndSize(
          "ThumbnailImages/" + this.name + ".jpg",
          this.contentClip.getSize()
        );
      }
      if (!this.properties.hideTitle) {
        ...
        var d = this.properties.titleClass
          ? " " + this.properties.titleClass
          : "";
        var e = this.properties.subtitleOnly
          ? "<div class='segmentSubtitleSolo'>" + this.subtitleString + "</div>"
          : this.subtitleString
          ? "<div class='segmentTitle" +
            d +
            "'>" +
            this.titleString +
            "</div><div class='segmentSubtitle'>" +
            this.subtitleString +
            "</div>"
          : "<div class='segmentTitleSolo" +
            d +
            "'>" +
            this.titleString +
            "</div>";
    ...
    setHighlighted: function(d) {
      this.window.setContentsURL(
        d ? "Images/WindowHighlighted.png" : "Images/Window.png"
      );
      if (d) {
        this.windowOverlay.setHidden(true);
      }
    ...
    touchDidMove: function(e) {
      ...
      var d =
        this.site.zoomedSegment != this &&
        this.containsGlobalPoint(e.globalPoint);
...
(function() {
  var b = (this.SitePageSet = new Class({
    ...
    initialize: function(e) {
      ...
      this.backgroundGradient.setSize(
        this.site.width,
        this.site.height + this.backgroundGradientY
      );
    },
    ...
    getAvailableHeightForPage: function(f) {
      var e =
        this.tocHeight *
        Math.max(0.51, f.segment.strip.stripScaleForPageOffset);
      e += f.segment.properties.pageYOffset || 0;
      return Math.round(
        this.site.height - e - this.site.xScroller.height - this.tocTopMargin
      );
    },
    updatePagePositionsAroundPage: function(j, e) {
      var m = Math.round(0.5 * (this.site.width - j.width) - 100).limit(
        100,
        200
      );
      if (!e) {
  ...
  var a = (this.SitePage = new Class({
    ...
    initialize: function(h, g) {
      ...
      if (gSiteShowPageImages) {
        this.previewContent.setContentsURL(
          "PageImages/" + this.segment.name + ".jpg"
        );
      }
      if (this.segment.properties.imageWidth) {
        this.previewContent.setSize(this.getSize());
      } else {
        var e = this.segment.properties.pageHeight
          ? Math.min(600, this.segment.properties.pageHeight)
          : 600;
      ...
      if (this.segment.captionString) {
        ...
        if (this.segment.properties.captionColor) {
          this.caption.setTextStyle(
            "color",
            "#" + this.segment.properties.captionColor
          );
        }
    ...
    preloadContent: function() {
      this.root.contentContainer.preload(
        this.segment.displayURL,
    ...
    setContentShowing: function(g) {
      ...
      if (!g) {
        ...
        var e = this.superlayer.getGlobalPointForLocalPoint(
          Math.round(0.5 * (this.site.width - this.width)),
          this.showingY
        );
        ...
        f.setURL(
          this.segment.displayURL,
          this.segment.contentClickURL,
          this.segment.properties
        );
        if (this.nextPage) {
          f.setPreloadURL(
            this.nextPage.segment.displayURL,
            this.nextPage.segment.properties
          );
        }
  ...
  var d = (this.SitePageShadow = new Class({
    ...
    update: function() {
      ...
      this.Left.setPosition(
        this.TopLeft.x,
        this.TopLeft.y - this.TopLeft.height
      );
  ...
  var c = (this.SitePageArrowRegion = new Class({
    ...
    initialize: function(f, e) {
      ...
      this.arrow.setContentsURLAndSize(
        "Images/PageArrow" + (e ? "Right" : "Left") + ".png",
        45,
        34
      );
      this.setHidden(true);
    ...
    updatePositionAroundPage: function(j) {
      ...
      this.arrow.setY(
        Math.max(
          lerp(h.y, -this.height + this.arrow.height, 0.25),
          h.y - 0.5 * (k.height - this.arrow.height)
        )
      );
    },
    mouseEntered: function() {
...
(function() {
  var b = (this.SiteContactSet = new Class({
    ...
    initialize: function(e, g) {
      ...
      this.topOrBottom = g;
      this.setAccelerated(true);
      this.setContentsURLAndSize(
        "Images/Contacts" +
          (this.topOrBottom == "top" ? "Top" : "Bottom") +
          ".png",
        61,
        16
      );
  ...
  var a = (this.SiteContact = new Class({
    ...
    setContactElement: function(c) {
      ...
      this.caption.setPositionOfLocalPoint(
        this.contactSet.width - this.x,
        d,
        e,
        0
      );
...
(function() {
  var b = (this.SiteScrollerThumb = new Class({
    ...
    initialize: function(e, d) {
      this.parent(e);
      this.scroller =
        this.getAncestorWithClass(c) || this.getAncestorWithClass(a);
  ...
  var c = (this.SiteXScroller = new Class({
    ...
    setThumbPosition: function(d, f) {
      ...
      this.site.setScrollX(
        lerp(this.site.getMaxScrollX(), this.site.getMinScrollX(), e)
      );
  ...
  var a = (this.SiteYScroller = new Class({
    ...
    setThumbPosition: function(d, f) {
      ...
      this.site.setScrollY(
        lerp(this.site.getMinScrollY(), this.site.getMaxScrollY(), e)
      );
    },
